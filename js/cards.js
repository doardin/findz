        ...
        card.innerHTML = `
            ...
            <div class="card-body">
                <div>
                    ...
                    <h6 class="card-text  price" style="font-weight: bold; margin: 0;">¥${item.price}</h6>
                </div>
                <div class="card-tags">
                    ${tagsHTML}
                </div>
            ...
            <div class="card-footer">
                <a href="${item.link}" class="btn green-button" style="width: 100%;" target="_blank">Ir para CSSBuy</a>
            </div>`;
